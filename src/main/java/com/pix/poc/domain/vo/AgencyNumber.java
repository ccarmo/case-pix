...
public class AgencyNumber {
    ...
    public AgencyNumber(Integer value){
        if (value == null) {
            throw new InvalidAccountNumberException("Numero de agencia invalido. Nao pode ser nulo");
        }
        String valueAsString = String.valueOf(value);
        if (valueAsString.length() > 4) {
            throw new InvalidAccountNumberException("Numero de agencia invalido. Máximo de 4 caracteres");
        }
